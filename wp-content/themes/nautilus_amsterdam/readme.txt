...
You have a dedicated sidebar for all community templates and an extra community template.  Enable community widgets or whatever you need.
You an extra template to write contents for your community.

== Set Up ==
Appaerance > Boot Store


== Changelog ==

= 1.6.2 =
* Fixed sidebars (broken in 1.6.2 version)
* Fixed carousel new fields

= 1.6.2 =
* Carousel fixes
* Carousel order option
* Carousel alternative link
* Carousel alternative title
* Carousel alternative excerpt
* Minor css fixes

= 1.6.1 =
* Fixed responsive menus styles
* WordPress admin tool bar visible for authors
